...
- (void)configurevideoEncoder {
    ...
    self.videoEncoder = [[XDXVideoEncoder alloc] initWithWidth:self.view.frame.size.width
    ...
    [self.videoEncoder configureEncoderWithWidth:self.view.frame.size.width
                                          height:self.view.frame.size.height];
}
