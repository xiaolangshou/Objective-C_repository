...
@interface CameraHandler ()<AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
...
- (void)configureCameraWithModel:(CameraModel *)model {
    NSError *error = nil;
    ...
    AVCaptureDevice *device = [CameraHandler getCaptureDevicePosition:model.position];
    
    // Set frame rate and resolution
    [CameraHandler setCameraFrameRateAndResolutionWithFrameRate:model.frameRate
...
- (void)captureOutput:(AVCaptureOutput *)output didDropSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection {
    ...
    if ([self.delegate respondsToSelector:@selector(CaptureOutput:didDropSampleBuffer:fromConnection:)]) {
