...
//  TLRecorderKit
//
//  Created by Thomas Lau on 2019/2/20.
//  Copyright © 2019年 蔚来物联科技（深圳）有限公司. All rights reserved.
//

#import "TLAudioTool.h"
#import "TLAudioFilePathTool.h"
#import "JKLameTool.h"
@interface TLAudioTool()<AVAudioRecorderDelegate>
...
@implementation TLAudioTool

TLSingleM(TLAudioTool)
...
/** 开始录音 */
- (void)beginRecordWithRecordName: (NSString *)recordName
                   withRecordType:(NSString *)type
               withIsConventToMp3:(BOOL)isConventToMp3
{
    // 正在录制就返回，防止多次点击录音
    ...
    if (![TLAudioFilePathTool TL_judgeFileOrFolderExists:cachesRecorderPath]) {
        
        // 创建 /Library/Caches/TLRecorder 文件夹
        [TLAudioFilePathTool TL_createFolder:cachesRecorderPath];
    }
