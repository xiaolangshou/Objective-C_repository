...
// 录音存放的文件夹 /Library/Caches/TLRecorder
#define cachesRecorderPath [NSHomeDirectory() stringByAppendingPathComponent:@"/Library/Caches/TLRecorder"]

typedef void(^AudioSuccess)(BOOL ret);

@interface TLAudioTool : NSObject

TLSingleH(TLAudioTool)
